...
const EXPERIMENTAL_CLIENT_METHOD_DEPENDENCY_TYPES: &[&str] = &[
    ...
    "WorkflowTeachMode",
    "WorkflowTeachSessionStatus",
    "WorkflowTeachEvidenceInput",
    "WorkflowDemonstrationKind",
    "WorkflowCandidateStatus",
    "WorkflowValidationSeverity",
    "WorkflowValidationFinding",
    "WorkflowValidationSummary",
    "WorkflowSimulationOutcomeKind",
    "WorkflowSimulationSummary",
    "WorkflowStepOrigin",
    "WorkflowStepReview",
    "WorkflowCapabilityInference",
    "WorkflowBindingProposal",
