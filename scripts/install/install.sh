...
# GitHub repository serving rust-v* releases. Forks and mirrors can point
# the installer at their own release publish without editing the script.
GITHUB_REPO="${CODEX_INSTALL_GITHUB_REPO:-openai/codex}"
