  ...
  return {
    ...
    channels: [
      ...
      },
      {
        ...
        name: "partner-app",
        kind: "partner",
        licenseValidUntil: "2026-06-01",
      },
      {
        id: "ch-6",
        name: "news-push-alerts",
        kind: "push",
    ...
    assets: [
      {
        id: "a-0301",
        kind: "image",
        name: "harbor-bridge-aerial.jpg",
        sizeMb: 4.2,
        width: 4096,
        height: 2304,
        credit: "City Photo Desk",
        license: "editorial",
        renditions: [
          { name: "thumbnail", dimensions: "320w", status: "ready" },
          { name: "social-card", dimensions: "1200x630", status: "ready" },
          { name: "hero", dimensions: "2560w", status: "ready" },
        ],
        checksum: "aa12fe31",
      },
      {
        id: "a-0302",
        kind: "image",
        name: "budget-hearing-chamber.jpg",
        sizeMb: 3.1,
        width: 3840,
        height: 2560,
        credit: "Staff",
      ...
      },
      {
        id: "a-0303",
        kind: "image",
        name: "ferry-terminal-render.png",
        sizeMb: 2.4,
        width: 3000,
        height: 2000,
        credit: "Port Authority (handout)",
        license: "editorial",
        renditions: [{ name: "hero", dimensions: "2560w", status: "ready" }],
        checksum: "cc41ab77",
      },
      {
        id: "a-0304",
        kind: "video",
        name: "terminal-timelapse.mp4",
        sizeMb: 82,
        width: 1920,
        height: 1080,
        credit: "City Photo Desk",
        license: "editorial",
        renditions: [
          { name: "web-1080p", dimensions: "1920x1080", status: "processing" },
        ],
        checksum: "dd0753e9",
      },
    ],
    stories: [
      {
        id: "st-0201",
        slug: "harbor-bridge-retrofit-begins",
        title: "Harbor bridge retrofit begins Monday",
        section: "news",
        authorId: "u-3",
        ...
        expectedVersion: 3,
        wordCount: 210,
        assets: [{ assetId: "a-0301", role: "hero" }],
      ...
      {
        id: "st-0202",
        slug: "city-budget-hearings-five-things",
        title: "City budget hearings: five things to watch",
        section: "metro",
        authorId: "u-3",
        ...
        expectedVersion: 2,
        wordCount: 168,
        assets: [{ assetId: "a-0302", role: "inline" }],
        channels: [],
      ...
      {
        id: "st-0203",
        slug: "new-ferry-terminal-designs",
        title: "New ferry terminal designs unveiled",
        section: "news",
        authorId: "u-3",
      ...
      {
        id: "st-0204",
        slug: "marathon-route-changes",
        title: "Marathon route changes draw mixed reviews",
        section: "sports",
        authorId: "u-3",
        ...
        expectedVersion: 2,
        wordCount: 96,
        assets: [{ assetId: "a-0303", role: "hero" }],
        channels: [],
      ...
      {
        id: "st-0205",
        slug: "council-stadium-funding-vote",
        title: "Council votes on stadium funding tonight",
        section: "metro",
        authorId: "u-3",
    ...
    socialPosts: [
      {
        ...
        storyId: "st-0201",
        network: "feedbook",
        text: "The Harbor Bridge retrofit starts Monday night — what it means for your commute.",
        status: "posted",
        scheduledAt: "2026-09-10T07:00:00Z",
        postedAt: "2026-09-10T07:00:00Z",
        engagement: { likes: 842, reposts: 61, clicks: 3102 },
      },
      {
        id: "sp-0102",
        storyId: "st-0201",
        network: "chirp",
        text: "Upper deck closes nightly at 22:00 starting Monday. Cyclists keep the path.",
        status: "scheduled",
    ...
    corrections: [
      {
        id: "c-0801",
        storyId: "st-0201",
        summary: "Fixed bus route numbers (12 and 44, not 14 and 42)",
        beforeText: "bus routes 14 and 42",
        afterText: "bus routes 12 and 44",
        byId: "u-2",
    ...
    notifications: [
      {
        ...
        to: "hana.kim",
        type: "editorial",
        subject: "Your story st-0204 was approved",
        text: 'Camille Dubois approved "Marathon route changes draw mixed reviews" for publication.',
        status: "delivered",
