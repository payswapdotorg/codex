...
| `missing_asset` | attach asset, rendition request, publish story | referenced asset / hero image treated as unresolvable | HTTP 404 `{error:"missing_asset"}`; natural case: publishing a story with no hero image attached |
