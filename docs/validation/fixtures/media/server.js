...
const failures = [
  ...
  { switch: 'missing_asset', applies_to: 'attach asset, rendition request, publish story', behavior: 'A referenced asset (or the hero image) is treated as unresolvable.', symptom: 'HTTP 404 {error:"missing_asset"}; natural case: publishing a story with no hero image attached.' },
